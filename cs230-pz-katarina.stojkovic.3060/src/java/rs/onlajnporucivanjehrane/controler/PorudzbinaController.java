...
import rs.onlajnporucivanjehrane.beans.PorudzbinaFacade;
...
public class PorudzbinaController implements Serializable {
    ...
    @EJB
    private rs.onlajnporucivanjehrane.beans.PorudzbinaFacade ejbFacade;
    ...
    public static class PorudzbinaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Porudzbina) {
                ...
                return getStringKey(o.getIdporudzbina());
            } else {
